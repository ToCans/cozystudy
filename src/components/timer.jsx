	...
	return (
		<div className="bg-slate-200 w-4/5 h-fit flex flex-col shadow-md rounded-lg mx-3 p-3 justify-center items-center">
			...
			<div className="row flex flex-row justify-center w-full space-x-2 m-1">
				<SoundButton purpose="None" audioPlayingSetter={setAudioPlaying} />
				<SoundButton purpose="Fire" audioPlayingSetter={setAudioPlaying} />
				<SoundButton purpose="Wind" audioPlayingSetter={setAudioPlaying} />
				<SoundButton purpose="Rain" audioPlayingSetter={setAudioPlaying} />
			</div>
		</div>
	);
}
