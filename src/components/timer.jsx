...
function Timer() {
    ...
    */
	...
	}, [settings.cycleNumber, timerRunning, minutesRemaining, secondsRemaining]);

	// Timer Display Information
	let cycleDisplay = Math.ceil(settings.cycleNumber / 2);

	return (
		<div className="bg-slate-200 container flex flex-col shadow-md rounded-lg  mx-auto p-5">
			...
			<p className="text-xl text-center">Current Cycle: {cycleDisplay}</p>
		</div>
	);
}
