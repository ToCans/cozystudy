	...
	if (purpose === "Start") {
		return (
			<button
				...
				className="sm:text-2xl sm:w-20 text-xl w-16 border-solid border-2 rounded-lg bg-slate-100 m-0.5 p-1 hover:font-semibold"
				style={{
					borderColor: `${settings.buttonProgressTheme[settings.themeIndex]}`,
				}}
			>
				Start
			</button>
